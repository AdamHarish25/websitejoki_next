  ...
  return (
    <header className="bg-white/80 backdrop-blur-sm sticky top-0 z-50 border-b border-gray-200/80">
      ...
      <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <Link href="https://wa.me/6285179808325" target="_blank" className="hidden lg:flex px-6 py-3 rounded-full items-center justify-center gap-3 text-white bg-green-600 shadow-md transition-transform hover:scale-95">
      ...
      <div className={`absolute top-0 right-0 h-screen w-full max-w-full bg-white shadow-xl z-30 transform transition-transform duration-300 ease-in-out ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        <div className="p-8 flex flex-col space-y-8 mt-16 bg-white">
          ...
          <Link href="https://wa.me/6285179808325" target="_blank" onClick={closeMenu} className="flex px-6 py-4 rounded-full items-center justify-center gap-4 text-white bg-[#2ECC71] shadow-md transition-transform hover:scale-95 text-lg">
            Konsultasi Gratis <FaWhatsapp />
          </Link>
        </div>
      </div>
