      ...
      <div className="container space-y-8 mx-auto px-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {services1.map((service, index) => (
             <div key={index} className="p-0 md:p-3 h-50 md:h-[450px] rounded-xl shadow-md text-left transition-transform hover:-translate-y-2">
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 '>
          {services2.map((service, index) => (
            <div key={index} className="p-0 md:p-3 h-80 md:h-[450px] rounded-xl shadow-md text-left transition-transform hover:-translate-y-2">
              <div className="relative w-full h-full mb-4 rounded-lg overflow-hidden">
                <Image src={service.image} alt={service.alt} fill className='object-cover' />
              </div>
            </div>
